...
- Global scrollbar thumb color changed from `--color-border-default` to `--color-border-overlay` for better visibility against dark menu/popover backgrounds (xpo-e1acfd)
