---
name: beats-backlog
description: "Review the project backlog using beats. Lists issues by status and suggests what to work on next."
disable-model-invocation: true
---

# Review the Beats Backlog
