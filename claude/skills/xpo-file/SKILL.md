---
name: xpo-file
description: "File a new xpo issue (bug, task, feature, or epic). Handles duplicate checking, proper labeling, and linking to related issues."
disable-model-invocation: true
---

# File a New Exponential Issue

You are creating a new issue in the xpo tracker. Follow this process to ensure quality and avoid duplicates.
...
```bash
xpo list --match "relevant search term"
```
...
```bash
xpo add "Title" --label "<type>" -p <epic-id> --desc "Description"
```

**If it relates to another issue:**

```bash
xpo link <new-id> <related-id> -t "relates_to"
```
